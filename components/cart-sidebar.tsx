...
export function CartSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-[460px] lg:w-[520px] bg-zinc-950 border-l border-zinc-800 z-50 transform transition-transform duration-300 ${
